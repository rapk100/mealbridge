      ...
      <Flex as="main" style={fcontstyle} flex="1" p={4}>
        ...
        <Box style={right} bg={bg} borderRadius="md" flex="1" color={color}>
          <Container maxWidth={'50%'} mt={10} flex="1">
            ...
            <Text mt={4}>
              Welcome to Meal-Bridge, a platform designed to streamline the process of receiving donations and managing food inventory and distribution for food banks.
            </Text>
            ...
            <Text mt={10}>
              We are committed to supporting Meal Brige in their vital work and are constantly working to enhance our platform. If you have any questions or feedback, please don't hesitate to contact us.
            </Text>
          </Container>        
        </Box>
